...
const Shipping: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8 text-gray-800">{t('shipping.title')}</h1>
      <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-md">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="relative">
            <input
              type="text"
              placeholder={t('shipping.productName')}
        ...
        <div className="mt-6">
          <button
            type="submit"
            className="w-full px-4 py-2 text-white bg-green-600 rounded-lg hover:bg-green-900"
          >
            {t('shipping.submit')}
          </button>
        </div>
